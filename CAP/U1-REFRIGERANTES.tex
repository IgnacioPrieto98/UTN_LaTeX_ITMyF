...
\newpage
	...
	\Biblio{\cite[pág. 774 a 775]{Rajput2011termodinamica} \cite[pág. 33, 36]{DossatPDRefrigeracion}}
	...
	En los sistemas de refrigeración la presión de evaporación debe estar lo más cerca de la presión atmosférica como sea posible y ser positiva. Una presión positiva se requiere a fin de eliminar la posibilidad de entrada de aire y humedad en el sistema. 
	...
	\paragraph{Temperatura crítica} La temperatura de un gas puede irse aumentando hasta un punto tal que no pueda saturarse a pesar del incremento de presión aplicado. La temperautra crítica de un gas es la tempertaura más alta que úede tener un gas sin lograr su condensación a la presión a la que está sujeto.
	
	
	La presión crítica es la presión más baja a la cual puede una sustancia existir en el estado líquido a su temperatura crítica, o sea, la presión de saturación a la temperatura crítica.

	En general, para un COP alto, la temperatura crítica debe ser muy alta tal que la línea de temperatura del condensador en un diagrama $p-h$ esté muy alejada del punto crítico. Esto asegura un efecto refrigerante razonable ya que es muy pequeña con el estado líquido antes de la expansión cerca del punto crítico. 

	La presión crítica debe ser baja para proporcionar una presión de condensación baja.


	
	\paragraph{Alta temperatura de saturación} Es la temperatura a la cual un fluido pasa de fase líquida a fase de vapor, o a la inversa, defase de vapor a la fase líquida. Para una determinada presión, la temperatura de saturación es la temepratura máxima que el líquido puede tener y la temperautra mínima que el vapor puede tener.

	\paragraph{Calor latente de vaporización} El calor latente de vaporización es aquella cantidad de energía absorbida o liberada durante el proceso de cambio de fase entre líquido y vapor. Esa energía es utilizada por el fluido para aumentar la separación molecular y el fluido pase de fase líquida a vapor. Debido a que no hay aumento en la energía cinética del fluido, la temperatura del fluido permanece consatnte.
	...
	\paragraph{Calor específico} El calor específico de cualquier sustancia es la cantidad de energía necesaria para producir un cambio de temperatura de $1^\circ C$ a un $kg$ de masa.
