...
\newpage
	...
	A continuación se hace una clasificación de refrigerantes según tres categorías principales: 

	\begin{itemize}
		\item Refrigeración a media o baja temperatura.
		\item Acondicionamiento de aire.
		\item Refrigeración a muy baja temperatura.
	\end{itemize}
	...
	\begin{table}[H]
		...
		\begin{tabular}{C{0.1\linewidth} C{0.1\linewidth} C{0.1\linewidth} M{0.3\linewidth} C{0.05\linewidth} C{0.05\linewidth} C{0.05\linewidth} C{0.05\linewidth}}
			Ref. & $T_{\text{mín}}$ & $\Delta \text{q}_{\text{vap}}$ & \Tcen{Aplicación} & \multicolumn{4}{c}{Lubricación} \\
			& 1 atm (°C) & $kJ/kg$ &  & Pl & Pg & AM & Ab \\
			\hline 
			R134a (HFC) & -26.05 & 217.0 & Acondicionamiento de aire. & A & B & & \\
			R401A (HCFC) & -34.38 & 222.6 & Ref. de expansión directa comercial e industrial. & A &  & B & B \\
			R401B (HCFC) & -35.72 & 228.4 & Ref. comercial e industrial. & A &  & B & B \\
			R402A (HCFC) & -49.16 & 194.4 & Ref. comercial e industrial.  & A &  & B & C \\
			R402B (HCFC) & -47.16 & 210.3 & Máquinas de hielo & A &  & B & C \\
			R404A & -46.55 & 200.3 & Máquinas de hielo & A &  &  & \\
			
		\end{tabular}
	\end{table}

	% Dentro de cada grupo presente en las tablas \ref{T1-Refrigeración para media o baja temperatura}, \ref{T1-Refrigeración para acondicionamiento de aire} y \ref{T1-Refrigeración para muy bajas temperaturas}; se dispone de un detalle de la aplicación y el lubricante que requiere cada uno de ellos. 

	% Estas listas son recomendaciones, mas la elección de los refrigerantes debe realizarse considerando también las características de un refrigerante ideal desarrolladas en la sección \ref{S1-Características de un refrigerante ideal}.


	\subsection{Refrigeración a media o baja temperatura}

	\begin{table}[H]
		\centering
		\caption{Refrigerantes para refrigeración a media o baja temperatura.}\label{T1-Refrigeración para media o baja temperatura} 
		\footnotesize
		\begin{tabular}{C{0.1\linewidth} C{0.1\linewidth} M{0.36\linewidth} M{0.36\linewidth}}
			Ref. & Remplaza & \Tcen{Detalle} & \Tcen{Lubricación} \\
			\hline
			R134a & R12 & Electrodomésticos, refrigeración (comercial y autónoma), enfriadoras centrífugas y aire acondicionado para automóviles. & Poliéster en equipos estacionarios y poliglicoles alcalinos en equipos de automóviles. \\
			R401A & R12 & Refrigeración de expansión directa para uso comercial e industrial a bajas temperaturas. & Combinaciones de aceite mineral y alquinobencenos o con poliésteres. \\
			R401B & R12 & Refrigeración de expansión directa para uso comercial e industrial a bajas temperaturas y sistemas de aire acondicionado remplazando R12. & Combinaciones de aceite mineral y alquinobencenos o con poliésteres. \\
			R402A & R502 & Refrigeración comercial e industrial en bajas temperaturas & Aceite mineral, alquinobencenos o poliésteres. \\
			R402B & R502 & Máquinas de hielo & Aceite mineral, alquinobencenos o poliésteres. \\
			R404A & R502 y R22 & Refrigeración comercial e industrial a medias y bajas temperaturas. Máquinas de hielo. &  Poliésteres. \\
			R407A & R22 & Refrigeración comercial e industrial a medias y bajas temperaturas. &  Poliésteres. \\
			R407C & R22 & Refrigeración comercial e industrial a temperaturas medias. Acondicionamiento de aire comercial y residencial. & Poliésteres. \\
			R408A & R502 & Refrigeración industrial a media y baja temperatura. & Aceite mineral, alquinobencenos o poliésteres. \\
			R409A & R12 & Refrigeración industrial a media y baja temperatura. Acondicionamiento de aire con sistemas no centrífugos. & Aceite mineral, alquinobencenos o poliésteres. \\
			R417C & R12 & Refrigeración a media y baja temperatura. &  Poliésteres o aceites minerales/alquinobencenos con aditivos para mejorar circulación. \\
			R422B & R22 & Refrigeración comercial e industrial a temperaturas media. Acondicionamiento de aire. & Poliésteres o aceites minerales/alquinobencenos con aditivos para mejorar circulación. \\ 
			R422C & R502 y R22 & Refrigeración comercial e industrial a temperaturas media. & Poliésteres o aceites minerales/alquinobencenos con aditivos para mejorar circulación. \\
			R422D & R22 &   Refrigeración comercial e industrial a temperaturas media y baja. Acondicionamiento de aire. & Poliésteres o aceites minerales/alquinobencenos con aditivos para mejorar circulación. \\ 
			R507 & R502 y R22 & Refrigeración comercial e industrial a medias y bajas temperaturas. Máquinas de hielo. & Poliésteres. \\
			\hline
		\end{tabular}
	\end{table}
	...
	\begin{table}[H]
		\centering
		\caption{Refrigerantes para acondicionamiento de aire.}\label{T1-Refrigeración para acondicionamiento de aire}
		\footnotesize
		\begin{tabular}{C{0.1\linewidth} C{0.1\linewidth} M{0.36\linewidth} M{0.36\linewidth}}
			Ref. & Remplaza & \Tcen{Detalle} & \Tcen{Lubricación} \\
			\hline
			R407C & R22 & Refrigeración comercial e industrial a temperaturas medias. Acondicionamiento de aire comercial y residencial. & Poliésteres. \\
			R410A & R22 & Acondicionamiento de aire y bombas de calor. Solo para equipamiento nuevo, no como recarga de equipos para R22. & Poliésteres. \\
			R414B & R12 & Refrigeración industrial y comercial de media o baja temperatura y aire acondicionado. & Alquinobencenos, aceites minerales o poliésteres. \\
			R422B & R22 & Refrigeración comercial e industrial a temperaturas media. Acondicionamiento de aire. & Poliésteres o aceites minerales/alquinobencenos con aditivos para mejorar circulación. \\ 
			R422D & R22 &   Refrigeración comercial e industrial a temperaturas media y baja. Acondicionamiento de aire. & Poliésteres o aceites minerales/alquinobencenos con aditivos para mejorar circulación. \\ 
			R123 & - & Enfriadores centrífugos grandes y baja presión. & Alquinobencenos o aceites minerales. \\ 
			R124 & - & Acondicionamiento de aire de grandes ambientes. & Alquinobencenos o aceites minerales. \\
			\hline
		\end{tabular}
	\end{table}

	\subsection{Refrigeración a muy baja temperatura}


	\begin{table}[H]
		\centering
		\caption{Refrigerantes para muy bajas temperaturas.}\label{T1-Refrigeración para muy bajas temperaturas}
		\footnotesize
		\begin{tabular}{C{0.1\linewidth} C{0.1\linewidth} M{0.36\linewidth} M{0.36\linewidth}}
			Ref. & Remplaza & \Tcen{Detalle} & \Tcen{Lubricación} \\
			\hline
			R23 & R13 y R503 & Refrigeración a muy bajas temperaturas & Poliésteres. Normalmente se utilizan aditivos que mejoran la circulación del refrigerante. \\
			R403B & R13 y R503 & Refrigeración a muy bajas temperaturas con un sistema de una sola etapa. & Aceite mineral, alquinobencenos o poliésteres. \\
			R508B & R13 y R503 & Refrigeración a muy bajas temperaturas en sistemas de cascadas (etapas múltiples). & Poliésteres. Normalmente se utilizan aditivos que mejoran la circulación del refrigerante. \\
			\hline
		\end{tabular}
	\end{table}
	...
	\Biblio{\cite[pág. 13.1 a 13.2]{ashrae2014refrigeration}}

	Un refrigerante secundario es un líquido usado como fluidos de transferencia de calor que ganan o pierden energía térmica sin cambiar de estado. Para muy bajas temperaturas, el refrigerante debe tener un punto de congelación adecuado por debajo de la temperatura del medio u objeto a enfriar. Estos refrigerantes son comúnmente llamados salmueras. 
	...
	\begin{table}[H]
		...
		\footnotesize
		\begin{tabular}{M{0.175\linewidth} C{0.125\linewidth} C{0.125\linewidth} C{0.15\linewidth} C{0.125\linewidth} C{0.125\linewidth}}
			\Tcen{Refrigerante} & Concentración (\%) & Punto de congelación (°C) & Caudal/Potencia ($L/s\, kW$) & Caída de presión ($\Delta P$) & Coeficiente de transferencia ($W/m^2 K$) \\
			\hline
