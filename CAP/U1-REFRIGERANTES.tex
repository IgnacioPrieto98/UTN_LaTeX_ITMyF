...
\newpage
	...
	Un \textbf{refrigerante} se define como cualquier sustancia que absorbe calor a través de su evaporación o condensación y lo pierde a través de su condensación o solidificación en un sistema de refrigeración.

	Los refrigerantes están vinculados a un medio mecánico y climatizan ambientes a partir de ellos, de modo que se cumpla la segunda ley de la termodinámica, la cual define que \emph{el calor, por sí mismo, no puede fluir de un cuerpo más frío a uno más caliente.}
	...
	\Biblio{\cite[pág. 388 a 390]{DossatPDRefrigeracion} \cite[pág. 772 a 773]{Rajput2011termodinamica}  \\ \cite[pág. 29.2 a 29.5]{ashrae2017fundamentals} \cite[pág. 890 a 905]{Whitten2016quimica} \cite[pág. 66 a 68]{BPEMDRI2019arg}}
	...
	Estos refrigerantes están identificados por tres cifras, donde su primera cifra siempre será un 7 y las restantes serán el peso molecular relativo del refrigerante.
	...
	En una mezlca azeotrópicala presión del vapor de la mezcla presenta un máximo o un mínimo para dada composición y presión, de modo que la mezcla se comporta en ese caso como una sustancia pura y tiene un punto de ebullición fijo, lo que significa que la composición de la fase líquida es igual a la de la fase gaseosa. 

	Estas mezclas no tienen deslizamiento de temperatura o glide. Es decir, no poseen un rango de temperaturas entre las cuales la mezcla se evapora o condensa a una dada presión. Estas mezclas pueden cargarse tanto en fase líquida como gaseosa.
	...
	En las mezclas zeotrópicas, la presión de vapor es intermedia entre las presiones de los componentes puros a una dada temperatura, y cuando el refrigerante hierve en el evaporador la condensación de la fase líquida es distinta a la de fase vapor. El líquido se enriquece en el componente de mayor punto de ebullición a medida que el componente de menor punto de ebullición pasa a fase vapor, de modo que la mezcla no se comporta como una sustancia única. 

	Esta característica de composición diferente entre la fase líquida y la fse vapor puede ocasionar problemas durante la carga del refrigerante durante la carga del refrigerante y en el caso de fuga del mismo, udiendo generarse una composición fuera de especificación que afectara al rendimiento del producto. Estas mezclas deben cargarse siempre en fase líquida.
	...
	\section{Características de un refrigerante ideal}\label{S1-Características de un refrigerante ideal}
	...
	\Biblio{
	% \cite[pág. 29.1 a 29.5]{ashrae2017fundamentals}
	 \cite[módulo 1]{BPEMDRI2019arg}}
	...
	Como puede verse, a partir del año 2010 se eliminó totalmente en nuetro país la importación y la producción de fluorocarbonos (CFC), y, en consecuencia, su uso se limita actualmente a lo contenido en equipos existente y a lo recuperado y/o reciclado de los mismos.
	...
	\begin{table}[H]
		...
		\centering
		\caption{Cronograma de reducción y eliminación del consumo de SAOs.}
		\begin{tabular}{M{0.2\linewidth} C{0.05\linewidth} C{0.05\linewidth} C{0.05\linewidth}}
			  & 2029 & 2035 & 2040 \\
			\hline
			HFCs & 10\% & 30\% & 50\% \\
			\hline
	...
	EL efecto invernadero es un proceso natural por el cual ciertos gases que están presentes en la atmósfera absorben radiación que la Tierra emite al espacio como consecuencia del calentamiento de su superficie por la radiación solar.

	Parte de esta radiación recibida es devuelta a la atmósfera como radiación térmica infrarroja que es absorbida por el vapor de agua, el dióxido de carbono ($CO_2$), el metano ($CH_4$), el óxido nitroso ($N_2 O$), los hidrofluorocarbonos (HCFCs), los perfluorocarbonos (PFC), y el hexafluoruro de azufre ($SF_6$), de orden exclusivamente antropogénico, que se denominan gases de efecto invernadero (GEIs o GHGs por sus siglas en inglés).

	De esta forma, el efecto invernadero hace que la temperatura promedio de la tierra sea alrededor de 15°C, contra los -18°C que tendría la superficie si el mismo no existirera. EN consecuencia, y como resultado de este efecto, el planeta se mantiene lo suficientemente templado como para hacer posible la vida; una pequeña variación en este delicado balance de absorción y emisión de energías puede causar graves problemas.

	Los productos de muchas actividades contribuyen sustancialmente al incremento del efecto invernadero: la quema de combustibles fósiles, la agaricultura, la ganadería, la deforestación, algunos procesos industriales y los depósitos de residuos urbanos provocan un aumento de las consentraciones de estos gases de efecto invernadero en la atmósfera.

	De esta manera, este incremento aumenta la absorción de la energía reflejada por la Tierra, lo cual produce finalmente el calentamiento global con todas las consecuencias potenciales conocidas: alternaciones en los régimes de precipitaciones, incremento en la desertificación, alteracione sde los ciclos agrícolas y el derretimiento de los hielos, lo que incrementaría el nivel del mar causando inundaciones en las zonas costeras.
	
	EL potencial de calentamiento global (GWP por sus siglas en inglés) es el índice que compara el poder o la capacidad de calentamiento de los diferentes gases a lo largo de un periodo de tiempo, en general 100 años, en relación a una emisión igual de $CO_2$, sustancia tomada como referencia. Cuanto mayor sea esta capacidad, mayor será el GWP. Este GWP está determinado, entre otros factores, por el tiempo de vida media en la atmósfera de los gases.
	
	Así, el efecto en la atmósfera de los gases de efecto invernadero puede convertirse a un valor equivalente de toneladas de $CO_2$ utilizando la siguiente expresión:

	\begin{equation}
	CO_{2eq} = \text{masa del gas } (ton) \times GWP
	\end{equation}

	Los compuestos halogenados son muchos más eficientes en absorber la radiación emitida por la Tierra que el $CO_2$, por lo que pequeñas cantidades de estos gases pueden contribuir significativamente al calentamiento de la atmósfera.
	...
	Entre los principales elementos que integraron la arquitectura del protocolo se cuentan:

	\begin{itemize}
		\item Compromisos cuantitativos que incluye metas de emisión y compromisos generales.
		\item Implementación de políticas y medidas nacionales y de mecanismo de flexibilización, que contribuyan a hacer viable el cumplimiento de los compromisos.
	...
	Los GEIs cubiertos por el protocolo de Kyoto son: dióxido de carbono $CO_2$, metano $CH_4$, óxido nitroso $N_2 O$, Hidrofluorocarbonos (HFC), perfluorocarbonos (PFCs) y hexafluoruro de azufre ($SF_6$).

	El acuerdo de París es el instrumento legal que sucedió al protocolo de Kyoto en el marco de la convención marco de las naciones unidas sobre el cambio climatico y fue adoptado por las partes de la convención en diciembre de 2015 en París.

	A través del mismo las partes de la convención (192 países) se comprometieron en adoptar objetivos de reducción de emisiones (mitigación) de modo cuantificado y comparable, en lo que conose como contribuciones nacionalmente determinadas (NDCs).	
	
	Con la firma de este Acuerdo, Argentina adoptó un compromiso legalmente vinculante en el que se compromete a presentar contribuciones al esfuerzo global de reducción de los gases de esfuerzo invernadero necesario para que no se superen los 2°C promedio sobre la superficie del planeta, y con ello exista una mayor probabilidad de evitar la ocurrencia de daños catastróficos e irreversibles.

	Las políticas con mayor impacto en la reducción de emisiones son:
	\begin{itemize}
		\item Planes de aprovechamiento forestal.
		\item Remplazo de lámparas incandescentes por LFC y LED.
		\item Incremento de la generación hidroeléctrica.
		\item Aumento de la generación empleando tecnología nuclear.
		\item Establecer normas de eficiencia energética para lavarropas, acondicionadores de aires, heladeras y freezers.
		\item Energías renovables. 
	\end{itemize}

	\subsection{Relación entre el agotamiento del ozono y el cambio climático}

	El agotamiento del ozono en la estratósfera y el cambio climático son efectos no deseados de las actividades humanes y constituyen problemas ambientales distintos pero relacionados de varias maneras debido a que:

	\begin{itemize}
		\item La capa de ozono influye en el mantenimiento del balacne térmico global del planeta, y
	...
	La eliminación de las SAOs por el protocolo de Montreal ha beneficiado al clima del planeta de otra manera. En el proceso de reconversión de estas sustancias, los equipos que las contienen se han ido perfeccionando de manera tal que las fugas se han reducido al mínimo por la aplicación de buenas prácticas en la manufactura y servicio.

	Asimismo, el rediseño de los equipos a fin de adaptarlos a los nuevos refrigerantes los ha hecho más aeficientes desde el punto de vista de consumo de energía.
	...
	\Biblio{\cite[pág. 29.6 a 29.10]{ashrae2017fundamentals} \cite{ashrae2019SSrefrigerationsistems}}
	...
	Por otro lado, los valores del 1 al 3 definen que tan inflamable es el refrigerante. Cuando se habla de refrigerantes clase 1, se entiende que este no generar propagación de flama en el aire en condiciones de $60^\circ C$ y $101.3kPa$; los refrigerantes clase 2 exhiben propagación de flama en esas condiciones, donde su límite de ignición es mayor que $0.10kg/m^3$ y el calor de combustión es menor que $19MJ/kg$; por último, los refrigerantes de clase 3 exhiben propagación de flama en el aire a $60^\circ C$ y $101.3kPa$, donde el límite de ignición es menor o igual a $0.10kg/m^3$ o el calor de combustión es mayor que $19MJ/kg$.
	...
	\Biblio{\cite{national2016guiarefrig}}
	...
	\Biblio{\cite[pág. 13.1 a 13.2]{ashrae2014refrigeration} \cite[Cap. 31]{ashrae2017fundamentals}}
	...
	\subsection{Algunos refrigerantes y sus propiedades}

	\paragraph{Refrigerantes basados en sales (salmueras)}
	...
	\paragraph{Fluidos que no son halocarbonos ni mezclas acuosas}
	...
	\subsection{Comparación de rendimento}
