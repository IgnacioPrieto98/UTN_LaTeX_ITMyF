...
\newpage
	...
	\begin{itemize}
		...
		\item Ciclo de refrigeración por compresión de vapor.
		\item Ciclo de refrigeración por absorción.
	\end{itemize}
	...
	\begin{equation}
		W_N + Q_{4 \rightarrow 1} = Q_{2\rightarrow 2' \rightarrow 3}
	\end{equation}
	...
	Con estos parámetros, el rendimiento del ciclo Rankine inverso resulta:

	\begin{equation}
		COP_R = \dfrac{h_1 - h_4}{h_1 - h_2}
	\end{equation}
