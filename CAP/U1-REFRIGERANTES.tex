...
\newpage
	...
	\Biblio{\cite[pág. 9 a ]{national2016guiarefrig}}

	La selección de refrigerantes depende de la capacidad de refrigeración deseada, las temperaturas, la disponibilidad, su ODP y su GWP, la reacción, corrosión, toxicidad e inflamabilidad, entre otros parámetros. A continuación se desarrollan opciones para algunos en función de las temperaturas, capacidades, y los refrigerantes que eran utilizados previamente.

	\subsection{Refrigeración a media o baja temperatura (Eq. de R502)}

	\begin{table}[H]
		\centering
		\small
		\begin{tabular}{C{0.15\linewidth} C{0.35\linewidth} C{0.2\linewidth} C{0.15\linewidth}}
			Refrigerante & Composición (porcentaje) & Relleno respecto a R502 & Lubricante \\
			\hline
			R402A & 125/290/22 \, (60\%, 2\%, 38\%) & 95\% a 100\% & AB o mezcla de AM y AB. \\
			R402B & 125/290/22 \, (38\%, 2\%, 60\%) & 95\% a 100\% & AB o mezcla de AM y AB. \\
			R404A & 125/143a/134a \, (44\%, 52\%, 4\%) & 85\% a 90\% & Polyester \\
			\hline
			% \multicolumn{4}{C{.7\linewidth}}{\footnotesize{AM: Aceites minerales \; AB: alquibenceno.}}
		\end{tabular}
	\end{table}
	...
	\subsection{Eficiencia volumétrica}
